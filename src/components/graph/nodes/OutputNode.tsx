...
function OutputNodeInner({ data, selected }: NodeProps & { data: ProcessingNodeData }) {
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex flex-col gap-0.5 min-w-0">
          <div className="flex items-center gap-1">
            <Flag size={12} className="text-text-secondary flex-none" />
            <span className="text-xs font-medium text-text-primary truncate">{data.label ?? 'Output'}</span>
          </div>
