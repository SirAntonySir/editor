 ...
 * the pin/"open on canvas" affordances, the canvas layers node, and
 * canvas-widget spawning from palette op/preset rows (those become a
 * deterministic launcher INTO the sidebar inspector instead).
 *
 ...
 * accordion inspector (writes canonical directly), presets, crop, layer
 * management via the inspector Layer tab, history/undo.
 *
