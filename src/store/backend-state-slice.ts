...
// WidgetShell currently renders at w=226px; height varies, but the spawn
// algorithm only needs an estimate to detect overlaps.
const WIDGET_SPAWN_SIZE = { w: 226, h: 60 };
 ...
 */
function tetherWorkspaceWidget(widget: Widget): void {
